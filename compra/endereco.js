...
function checkInputs() {
  ...
  if (lastNameValue === "") {
    setErrorFor(lastName, "O nome de sobrenome é obrigatório.");
  } else {
  ...
  if (cepValue === "") {
    setErrorFor(cep, "O CEP é obrigatória.");
  } else if (cepValue.length < 7 || cepValue.length > 8) {
  ...
  if (numberValue === "") {
    setErrorFor(number, "O número da residência é obrigatório");
  } else {
